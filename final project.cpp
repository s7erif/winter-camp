...
int main() {
    ...
    do { // الحلقة الخارجية للقائمة الرئيسية
            ...
            do {
                ...
                switch (book) {
                    ...
                    case 6: {
                        string new_book;
                        cout << "Enter the name of the book to add: ";
                        cin.ignore(); // إضافة هذه السطر لتجنب مشكلة السطر الفارغ بعد 
                        getline(cin, new_book);
                    ...
                    case 9: {
                        ...
                        if (Ar_borrowed_books >= 1){
                            cout <<Ar_borrowed_books , "The books has been returned";
    ...
    } while (choice == 1 || choice == 2); // استمر في عرض القائمة الرئيسية ما دام المستخدم يختار مكتبة
